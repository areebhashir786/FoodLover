<%-- 
    ...
    Created on : May 29, 2020, 3:49:00 AM
    Author     : areeb
--%>
...
<html>
    ...
    <body>
              ...
              <form id = "removeStaff" action="RemoveStaffServlet" method="post">  
                    ...
                    <div class="card bg-light">
                        <div class="row">
                            <article class="card-body mx-auto col-md-8">
                                <h2 class="card-title mt-3 text-center">Remove Staff</h2>
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input name="StaffId"  class="form-control" placeholder="Enter Staff Id" type="text" required>
                                </div>
