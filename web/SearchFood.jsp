<%-- 
    Document   : SearchFood
    Created on : May 28, 2020, 11:17:37 PM
    Author     : areeb
--%>
...
<html>
    ...
    <body>
        ...
        <form id = "searchFood" action="SearchFoodServlet" method="post">  
                    ...
                    <div class="card bg-light">
                        <div class="row">
                            <article class="card-body mx-auto col-md-8">
                                <h2 class="card-title mt-3 text-center">Search Food</h2>
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input name="foodName"  class="form-control" placeholder="Enter Food Name" type="text" required>
                                </div>
